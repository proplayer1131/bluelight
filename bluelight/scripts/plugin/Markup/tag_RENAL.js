...
function loadWriteTAG_RENAL() {
    ...
    var span = document.createElement("SPAN");
    span.innerHTML = `<img class="innerimg TAG" alt="writeTAG_RENAL" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" id="writeTAG_RENAL" src="../image/icon/lite/tag_renal.png" width="50" height="50">`;
